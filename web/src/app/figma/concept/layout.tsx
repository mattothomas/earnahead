      ...
      <header className="border-b bg-white sticky top-0 z-50" style={{ borderColor: '#E2E8F0' }}>
        <nav className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <Link href="/figma/concept" className="flex items-center gap-2" style={{ textDecoration: 'none' }}>
            ...
            <div className="flex items-center gap-6">
              <Link href="/figma/concept/dashboard" className="flex items-center gap-1.5 text-sm font-medium" style={{ color: '#64748B', textDecoration: 'none' }}>
                <LayoutDashboard className="w-4 h-4" /> Dashboard
              </Link>
              <Link href="/figma/concept/impact" className="flex items-center gap-1.5 text-sm font-medium" style={{ color: '#64748B', textDecoration: 'none' }}>
                <BarChart3 className="w-4 h-4" /> Impact
              </Link>
              <Link href="/figma/concept/stories" className="flex items-center gap-1.5 text-sm font-medium" style={{ color: '#64748B', textDecoration: 'none' }}>
